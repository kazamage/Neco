...
public class NecoProcessor extends AbstractProcessor {
    ...
    public class Model {
        ...
        private String toMetaPackageName(String baseName) {
            String packageName = getOption(PACKAGE, baseName);
            String packageSuffix = getOption(PACKAGE_SUFFIX, null);
        ...
        private String toMetaClassName(String baseName) {
            String prefix = getOption(CLASS_PREFIX, null);
            String suffix = getOption(CLASS_SUFFIX, null);
